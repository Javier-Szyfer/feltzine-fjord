export const fjordDrop1MainnetAbi = [
  {
    inputs: [
...
export const hellHouseABI = [
  ...
  {
    inputs: [
      { internalType: 'enum HellHouse.MintPhase', name: 'val_', type: 'uint8' },
    ],
    name: 'setMintStage',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    ...
    name: 'stage',
    outputs: [
      { internalType: 'enum HellHouse.MintPhase', name: '', type: 'uint8' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
