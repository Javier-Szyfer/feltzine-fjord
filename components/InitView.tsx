...
const InitView = ({ enter, setEnter }: any) => {
  ...
  return (
    <motion.div
      ...
      className="relative w-full px-4 sm:max-w-2xl lg:max-w-4xl lg:shadow-xl lg:shadow-stone-600/50  h-full min-h-[80vh] mt-6 md:mt-6 flex flex-col justify-between items-center "
    >
      <News size="2xl" />
      ...
      <motion.button
        ...
        className=" text-lg bg-[#202020] text-[#dddddd] hover:text-[#f6f6f6] mt-4 cursor-fancy text-shadowFirst py-2 px-4 shadow-md shadow-gray-50/80 rounded-none mb-4"
      >
        ENTER
      </motion.button>
    </motion.div>
