...
const Drop1Tv = ({
  ...
  return (
    <motion.div
      ...
      className="text-drop1 relative text-sm lg:text-lg border-[0.9px] h-full w-full mt-4 md:mt-0 border-[#302e2e84] shadow-xl shadow-red-800/10 hover:shadow-[#ff370030]/30 text-[#ff0000] min-h-[60vh] p-4 bg-[#01000055] opacity-95"
    >
      <video
